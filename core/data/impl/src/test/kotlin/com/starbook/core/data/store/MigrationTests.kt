...
class MigrationTests {
  ...
  private val factory: StarBookDataStoreFactory =
    StarBookDataStoreFactory(Json { ignoreUnknownKeys = true }, ApplicationProvider.getApplicationContext())
  ...
  fun `defaults are used when SharedPreferences empty`() = runTest {
    ...
    assertEquals(expected = ThemeColorScheme.StarBookBlue, actual = testGraph.themeColorSchemeStore.data.first())
  }
