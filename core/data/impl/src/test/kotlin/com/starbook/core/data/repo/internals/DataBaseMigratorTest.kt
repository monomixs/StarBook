...
import com.starbook.core.data.repo.internals.allMigrations
import com.starbook.core.data.repo.internals.getFloat
import com.starbook.core.data.repo.internals.getInt
import com.starbook.core.data.repo.internals.getString
import com.starbook.core.data.repo.internals.getStringOrNull
import com.starbook.core.data.repo.internals.mapRows
...
class DataBaseMigratorTest {
  ...
  private fun dbPath(name: String): String {
    return InstrumentationRegistry.getInstrumentation().targetContext.getDatabasePath(name).absolutePath
  }

  @Test
  fun emptyTableLeadsToCorrectSchema() {
    val dbName = "testDb"
    val db = helper.createDatabase(dbPath(dbName), 43)
  ...
  fun migrate44() {
    val dbName = "testDb"
    val db = helper.createDatabase(dbPath(dbName), 44)
