...
import com.starbook.features.bookmark.dialogs.AddBookmarkDialog
import com.starbook.features.bookmark.dialogs.EditBookmarkDialog
  ...
  Scaffold(
    ...
    floatingActionButton = {
      FloatingActionButton(
        onClick = onAdd,
        content = {
          Icon(imageVector = StarBookIcons.Add, contentDescription = stringResource(id = StringsR.string.common_action_add))
        },
      )
    },
  ) { paddingValues ->
    ...
    backgroundContent = {
      Box(
        ...
        Icon(
          ...
          imageVector = StarBookIcons.Delete,
            ...
            if (bookmark.showSleepIcon) {
              Icon(
                modifier = Modifier
                  .padding(start = 4.dp)
                  .size(16.dp),
                imageVector = StarBookIcons.Timer,
        ...
        trailingContent = {
          Box {
            IconButton(
              ...
              content = {
                Icon(
                  imageVector = StarBookIcons.MoreVert,
