...
readonly PACKAGE="com.starbook.core.ui.icons"
readonly OUT_DIR="core/ui/src/main/kotlin/com/starbook/core/ui/icons"
...
cat > "${OUT_DIR}/StarBookIcons.kt" <<EOF
package ${PACKAGE}
