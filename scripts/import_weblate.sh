...
origin_url="${ORIGIN_URL:-git@github.com:starbook-org/StarBook.git}"
strings_url="${STRINGS_URL:-https://hosted.weblate.org/git/StarBook/strings}"
metadata_url="${METADATA_URL:-https://hosted.weblate.org/git/StarBook/metadata/}"
