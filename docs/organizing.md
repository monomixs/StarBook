...
StarBook offers three simple ways to organize your audiobooks based on how you store them on your device. Pick the option that matches your
setup best:
...
StarBook recognizes three audiobooks: `TheHobbit`, `MobyDick`, and the single-file book `LittlePrince`.
...
StarBook recognizes one audiobook: `PrideAndPrejudice`.
...
StarBook recognizes authors (`Woolf`, `Tolkien`) and their audiobooks (`MrsDalloway`, `ToTheLighthouse`, `TheHobbit`).
