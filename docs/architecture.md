...
StarBook is built on a **modular, layered architecture**. The design separates infrastructure, shared domain logic, and user-facing features.
...
* `:features:review:noop` – App review prompts
