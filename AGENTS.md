...
- Run all unit tests: `./gradlew starbookUnitTest`.
...
- Run the narrowest meaningful test first. Broaden to `./gradlew starbookUnitTest` when touching shared behavior, cross-module contracts, or
  risky refactors.
