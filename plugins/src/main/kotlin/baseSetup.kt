...
fun Project.baseSetup() {
  ...
  tasks.withType<KotlinCompile>().configureEach {
    compilerOptions {
      ...
      allWarningsAsErrors.set(providers.gradleProperty("com.starbook.warningsAsErrors").map(String::toBooleanStrict))
    }
  }
  ...
  extensions.configure<CommonExtension> {
    namespace = "com.starbook." + path.removePrefix(":").replace(':', '.')
